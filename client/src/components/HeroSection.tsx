...
export default function HeroSection() {
  ...
  const handleDownloadCV = async () => {
    ...
    try {
      ...
      link.href = '/Muhammad-Kamal-Hj-Kifli-CV.png';
      link.download = 'Muhammad-Kamal-Hj-Kifli-CV.png';
    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative" data-testid="hero-section">
      <div className="container mx-auto px-6 text-center">
        <div className="terminal-window rounded-lg p-8 max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-cyber font-bold mb-4 whitespace-nowrap">
            <span className="text-white">CYBER</span>
            <span className="text-matrix-green">SECURITY</span>
          </h1>
